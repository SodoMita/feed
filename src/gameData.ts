...
export const CARDS: Card[] = [
...

  {
    ...
    characterEmoji: '🌱',
    characterName: 'Саша',
    text: 'Привет! Я подписался. Ты пишешь честно — мне нравится.\n\nЕсли что, могу позвать всех своих. Одно твоё слово — и они здесь.',
...

  {
    ...
    characterEmoji: '⏰',
    characterName: 'Время',
    text: 'На контент уходит по пять часов в день. Друзья звонят уже третий раз за неделю.\n\n«Ну так что, идёшь?» — в трубке смех и музыка. «Не сегодня»?',
    leftChoice: {
...

  {
    ...
    characterEmoji: '😤',
    characterName: 'Хейтер',
    text: '«...я просто не понимаю, зачем ты это делаешь, если это всё равно никому не нужно»\n\nМожно спросить «зачем ты здесь?» — и, может быть, услышать человека. А можно промолчать. Такие обычно уходят сами.',
...

  {
    ...
    text: 'Пост собрал много лайков — первая маленькая победа! 🎉\n\nВолна ещё не спала. Пока она гудит, можно уже заливать следующий.',
...

  {
    ...
    text: 'Рост замедлился. Конкуренты обгоняют. Спонсоры нервничают.\n\nВнутри два голоса: «Три поста в день — и нагонишь их!» и «Ты не машина. Притормози».\n\nК какому прислушаешься? Замедлишься?',
    leftChoice: {
...

  {
    ...
    text: 'Перевалило за круглую цифру! 🎉\n\nТелефон плавится от поздравлений. Лента уже нашёптывает про следующую цифру.\n\nА можно просто... никуда не спешить. Сегодня.',
...

  {
    ...
    characterEmoji: '🫥',
    characterName: 'Копия',
    text: 'Кто-то скопировал твой формат. Один в один. Даже шрифт тот же.\n\nМожно написать ему. А можно вспомнить: имитация — лучший комплимент. И просто пройти мимо.',
...

  {
    ...
    characterEmoji: '🌙',
    characterName: 'Ночь',
    text: '3:00 ночи. Идея не отпускает — жужжит, светится, тянет к экрану.\n\nЗаписать в черновики — и до утра. Если получится уснуть после.',
...

  {
    ...
    characterEmoji: '📡',
    characterName: 'Алгоритм (А.)',
    text: 'Охват максимален. Ты везде. Каждая лента видит тебя.\n\n«Как ты себя чувствуешь?» — спросит сегодня Саша. И ты вдруг не находишь ответа.\n\nСкажешь честно: «не знаю»?',
...

  {
    ...
    text: 'Помнишь, ты помог мне начать? Теперь у меня уже 5000 подписчиков. Спасибо тебе!\n\nОн вырос. И его аудитория рядом с твоей смотрится очень выгодно.\n\nПредложишь ему коллаб?',
...

  {
    ...
    text: 'Красивый закат. Телефон в руке.\n\nПалец уже сам ползёт к камере. Публика любит закаты — а этот особенно хорош.',
...

  {
    ...
    characterEmoji: '🧱',
    characterName: 'Блок',
    text: 'Ничего не приходит в голову. Полная пустота. Уже неделю.\n\nДисциплина советует: сделай хоть что-то. Любое «что-то» лучше, чем «ничего».',
