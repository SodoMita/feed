...
export const CARDS: Card[] = [
...

  {
    ...
    characterEmoji: '💭',
    characterName: 'Мысль',
    text: 'Первый пост почти никто не увидел. Что дальше?\n\nМожно продолжать в том же тоне — или попробовать что-то новое.',
...

  {
    ...
    text: 'Лента любит ритм. Планировщики советуют готовить контент на неделю вперёд. Вдохновение — жить моментом.\n\nЧей голос громче?',
...

  {
    ...
    text: 'Новый тренд набирает обороты. Все делают это.\n\nТренды живут три дня — лента уже решила, что это твоё.',
...

  {
    ...
    text: 'Платформа пишет: теперь ты можешь монетизировать контент.\n\nПодключить?',
...

  {
    ...
    text: 'Микрофон за 800 ₽ или встроенный в ноутбук?\n\nЗвук влияет на качество.',
...

  {
    ...
    characterEmoji: '🎯',
    characterName: 'Веха',
    text: 'Первая круглая цифра подписчиков! Красиво.\n\nПоздравления от знакомых.',
    // L: soul+1,energy+1  R: reach+1,money+1  | Both purely positive
    leftChoice: {
